  ...
  <div class="container-fluid">
    <div class="rui-navbar-content">
      <ul class="nav">
        <li
          class="
            dropdown dropdown-hover dropdown-keep-open dropdown-triangle
          "
        >
          <a
            href="#actions"
            ...
            ></span>
            <span>Actions</span> <span class="rui-dropdown-circle"></span
          ></a>
            ...
            <li>
              <a href="#create-post" class="nav-link"
                ><span
                  ...
                  class="rui-icon rui-icon-stroke-1_5"
                ></span>
                <span>Create Post</span> <span class="rui-nav-circle"></span
              ></a>
            </li>
            <li>
              <a href="#create-page" class="nav-link"
                ><span
                  ...
                  class="rui-icon rui-icon-stroke-1_5"
                ></span>
                <span>Create Page</span> <span class="rui-nav-circle"></span
              ></a>
            </li>
            <li>
      ...
      <ul class="nav rui-navbar-right">
        ...
        <li
          class="
            dropdown dropdown-hover dropdown-triangle dropdown-keep-open
          "
        >
          <a
            class="dropdown-item"
          ...
          <ul class="nav dropdown-menu rui-navbar-dropdown-language">
            ...
            <li>
              <a href="#" class="rui-navbar-language"
                ><span class="rui-navbar-language-img"
                  ><img src="./assets/images/china.svg" alt="" /></span
                >China</a
              >
            </li>
            <li>
              <a href="#" class="rui-navbar-language"
                ><span class="rui-navbar-language-img"
                  ><img src="./assets/images/germany.svg" alt="" /></span
                >Germany</a
              >
            </li>
            <li>
              <a href="#" class="rui-navbar-language"
                ><span class="rui-navbar-language-img"
                  ><img src="./assets/images/japan.svg" alt="" /></span
                >Japan</a
              >
            </li>
            <li>
              <a href="#" class="rui-navbar-language"
                ><span class="rui-navbar-language-img"
                  ><img src="./assets/images/spain.svg" alt="" /></span
                >Spain</a
              >
            </li>
          </ul>
        ...
        >
          <a
            ...
            ><span class="btn btn-custom-round"
              ...
              ></span>
              <span class="badge badge-circle badge-brand">3</span></span
            ></a
          >
                ...
                <a href="profile.html" class="media-link"
                  ...
                  ><span class="media-body"
                    ...
                    <small class="media-subtitle"
                      >Bring abundantly creature great...</small
                    >
                  </span></a
            ...
            <li>
              <a href="profile.html" class="nav-link"
                ><span
                  ...
                  class="rui-icon rui-icon-stroke-1_5"
                ></span>
                <span>Exit</span> <span class="rui-nav-circle"></span
              ></a>
            </li>
          </ul>
        </li>
              ...
              >
                ...
                <label
                  ...
                  ><span
                    ...
                    class="rui-icon rui-icon-stroke-1_5"
                  ></span>
                  <span>Dark</span> <span class="rui-dropdown-circle"></span
                ></label>
              </div>
            </li>
            <li>
        ...
        <li>
          <a href="profile.html" class="nav-link"
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Create new Post</span> <span class="rui-nav-circle"></span
          ></a>
        </li>
        <li>
          <a href="profile.html" class="nav-link"
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Manage Users</span> <span class="rui-nav-circle"></span
          ></a>
        </li>
        <li>
          <a href="profile.html" class="nav-link"
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Check Updates</span> <span class="rui-nav-circle"></span
          ></a>
        </li>
        <li>
          <a href="profile.html" class="nav-link"
        ...
        <li class="nav-item">
          <a
            ...
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Search</span> <span class="rui-nav-circle"></span
          ></a>
        </li>
        <li class="dropdown dropdown-keep-open">
          <a
            ...
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Language</span> <span class="rui-dropdown-circle"></span
          ></a>
          <ul class="nav dropdown-menu rui-navbar-dropdown-language">
            <li>
              <a href="#" class="rui-navbar-language active"
        ...
        <li class="nav-item">
          <a
            ...
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>Messenger</span> <span class="rui-nav-circle"></span
          ></a>
        </li>
        <li class="dropdown dropdown-keep-open">
          <a
            ...
            ><span
              ...
              class="rui-icon rui-icon-stroke-1_5"
            ></span>
            <span>More</span> <span class="rui-dropdown-circle"></span
          ></a>
          <ul class="nav dropdown-menu">
            <li>
              <div
