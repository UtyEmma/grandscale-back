 ...
 */ !(function (t) {
  ...
  6: function (t, e, n) {
    ...
    function g() {
      clearTimeout(p),
        (p = setTimeout(function () {
          if (f.length) for (var t = 0; t < f.length; t++) f[t]();
        }, 50));
    }
    function v(t) {
      "function" == typeof t
    ...
    function P() {
      var t = r.scrollTop(),
        e = "";
      (e = t > x ? "down" : t < x ? "up" : "none"),
        0 === t ? (e = "start") : t >= d - c && (e = "end"),
    ...
    function T(t) {
      t && !w
        ? ((w = 1),
          j(),
          b &&
            (void 0 === k && (k = l.css("padding-right") || ""),
            y &&
              l
                .add(a(".rui-navbar-mobile"))
                .css("paddingRight", "".concat(b, "px"))),
        ...
        : !t &&
          ...
          l.css("overflow", ""),
          b &&
            (l.css("paddingRight", k),
            a(".rui-navbar-mobile").css("paddingRight", "")));
    }
    function z(t, e) {
    ...
    function I(t) {
      ...
      (this.options = a.extend({}, this.options, t)),
        (this.options.templates = e),
        (this.options.events = n);
    }
    function D() {
      var t = this,
        ...
        n = null;
      if (
        ((t.setLoadingAnimation = function () {
          var t =
            !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
          clearTimeout(n),
            t
              ? (l.addClass("rui-page-loading-state"),
                e.addClass("rui-page-preloader-active"))
              : (l.removeClass("rui-page-loading-state"),
          ...
          function (e) {
            ...
            e.which > 1 ||
              ...
              (window.location.protocol === n.protocol &&
                ...
                ((n.href.indexOf("#") > -1 && c(n.href) === c(i)) ||
                  ("file:" !== window.location.protocol &&
                    (e.isDefaultPrevented() ||
                      (void 0 !== t.options.events.onBeforeAjax &&
                        t.options.events.onBeforeAjax(e)) ||
                      (e.preventDefault(), v(n.href))))));
          }
        ),
            ...
            ? (function (t, e) {
                switch (t.type) {
                  case "style":
                    ...
                    var i =
                      !!t.afterCSS && a('link[href="'.concat(t.afterCSS, '"]'));
      ...
      function f(e, n, o) {
        if (n) {
          ...
          u(s)
            ? (o
                ? window.history.replaceState(null, l, e)
                : window.history.pushState(null, l, e),
              (function () {
                var e =
                ...
                n.find('link[rel="stylesheet"]').each(function () {
                  ...
                  n.find("script[src]").each(function () {
                    ...
                    a('script[src="'.concat(t, '"]')).length ||
                      d.push({ src: t, type: "script" });
                  }),
                  p(d, function () {
                    ...
                    a("title").html(d),
                      ...
                      o.html(s.html()),
                      a(".rui-page-additional-js-ajax").remove(),
                      l.each(function () {
                        var t = a(this).clone();
                        t.addClass("rui-page-additional-js-ajax"),
                          t.appendTo("body");
                      }),
                      void 0 !== t.options.events.onAfterAjax &&
                        t.options.events.onAfterAjax(e, n),
                      r.trigger("rui-ajax-loaded", e, n),
      ...
      function g(e, n) {
        0 !== n.status
          ? (console.log("error", n), t.setLoadingAnimation(!1))
          : (window.location = e);
      }
      function v() {
            ...
            beforeSend: function () {
              ...
              return i
                ? (i.then(
                  ...
                  !1)
                : (t.setLoadingAnimation(!0), d(e, a.Deferred()), !0);
            },
            success: function (t) {
              var i = h(e);
    ...
    function R() {
      ...
      t.toggleNightMode(n),
        s.on("change", "input.rui-nightmode-toggle", function () {
          t.toggleNightMode();
        });
    }
    function A() {
      ...
      i.length &&
        t.throttleScroll(function (t, e) {
          "down" === t && e > 400
            ? i.removeClass("rui-navbar-show").addClass("rui-navbar-hide")
            : ("up" !== t && "end" !== t && "start" !== t) ||
              i.removeClass("rui-navbar-hide").addClass("rui-navbar-show");
        });
      var o = a(".rui-navbar-mobile"),
        r = o.find(".rui-navbar-collapse");
      function u() {
        if (!t.isNightMode()) {
          a("input.rui-darkNavbar-toggle").prop(
            "checked",
            e.hasClass("rui-navbar-dark")
          );
          var n = "";
          (n = e.hasClass("rui-navbar-dark") ? "night" : "day"),
            a(".rui-navbar [data-src-".concat(n, "]")).each(function () {
              var t = a(this);
              t.attr("src", t.attr("data-src-".concat(n)));
            });
        }
      ...
      s.on(
        ...
        ".rui-navbar-collapse",
        function (t) {
          "show" === t.type && (o.addClass("rui-navbar-show"), T(1)),
            "hide" === t.type && (o.removeClass("rui-navbar-show"), T(0));
        }
      ),
        ...
        (n.hasClass("rui-navbar-fixed") || n.hasClass("rui-navbar-sticky")) &&
          S(function (t, e) {
            e > 200
              ? n.addClass("rui-navbar-scroll")
              : n.removeClass("rui-navbar-scroll");
          }),
        u(),
        s.on("change", "input.rui-darkNavbar-toggle", function () {
      ...
      function t() {
        a(".dropdown:not(.rui-dropdown-triangle-ready)")
          ...
          .each(function () {
            ...
            t.hasClass("dropdown-triangle") &&
              e.append('<span class="dropdown-menu-triangle"></span>');
          });
      }
      s.on("mouseenter mouseleave", ".dropdown.dropdown-hover", function (t) {
        var e = a(this);
        "mouseenter" === t.type &&
          (e.children(".dropdown-item").dropdown("toggle"),
          e.parents(".dropdown-hover").length &&
            e.parents(".dropdown-menu").dropdown("show")),
          "mouseleave" === t.type &&
            (e.children(".dropdown-item").dropdown("toggle"),
            e.parents(".dropdown-hover").length &&
              e.parents(".dropdown-menu").dropdown("show"));
        ...
        s.on("show.bs.dropdown", ".dropdown", function () {
          var t = a(this),
            e = t.children(".dropdown-menu");
          t.hasClass("dropdown-hover")
            ? (t.addClass("hover"), e.addClass("hover"))
            : (t.addClass("focus"), e.addClass("focus"));
        }),
        s.on("hidden.bs.dropdown", ".dropdown", function () {
          var t = a(this),
            e = t.children(".dropdown-menu");
          t.hasClass("dropdown-hover")
            ? (t.removeClass("hover"), e.removeClass("hover"))
            : (t.removeClass("focus"), e.removeClass("focus")),
            t.hasClass("dropdown-autoposition") &&
              (t.removeClass("dropdown-autoposition"),
              t.children(".dropdown-item").dropdown("dispose"));
        }),
        s.on("shown.bs.dropdown", ".dropdown", function () {
          ...
          e.css("margin-left", ""),
            i.css("margin-left", ""),
            e.offset().left + e.outerWidth() > u &&
              (t.addClass("dropdown-autoposition"),
              n.dropdown("update"),
              e.css(
                "margin-left",
                (e.offset().left + e.outerWidth() - (u - 27)) / -1
              ),
              i.length &&
                i.css(
                  "margin-left",
                  n.offset().left -
                    i.offset().left +
                    (n.outerWidth() / 2 - i.outerWidth() / 2)
                )),
            setTimeout(function () {
              t.parents(".dropdown-hover").length &&
                (e
                  .attr("x-placement", "right-start")
                  .css({ transform: "", left: "", top: "" }),
                e.offset().top + e.outerHeight() > c &&
                  e.attr("x-placement", "right-end"),
                e.offset().left + e.outerWidth() > u &&
                  (e.attr("x-placement", "left-start"),
                  e.offset().top + e.outerHeight() > c &&
                    e.attr("x-placement", "left-end")));
            }, 10);
        }),
    ...
    function _() {
        ...
        a(".rui-messenger:not(.rui-messenger-ready)")
          ...
          .each(function () {
            ...
            function o() {
              ...
              if (a) {
                ...
                if (l && s.length) {
                  ...
                  r === h
                    ? o.find("ul > li:last").after("<li></li>").next()
                    : (o.after(s.clone()),
                      (o = e.find(".rui-messenger-message:last")).removeClass(
                        "rui-messenger-message-structure"
                      ),
                      o.find(".rui-messenger-message-time").text(h));
            ...
            setTimeout(function () {
              ...
              t.hasClass("rui-messenger-mini") &&
                s.on("afterClose.fb", function () {
                  t.removeClass("open show"), e.removeClass("open show");
                }),
              i(t.find(".rui-messenger-message li")),
              e.find(".rui-messenger-send").on("click", function (t) {
                t.preventDefault(), o();
              }),
      ...
      t(),
        r.on("rui-ajax-loaded", t),
        s.on("click", ".rui-messenger-item, .rui-messenger-back", function (t) {
          t.preventDefault();
          var e = a(this),
          ...
          if (e.hasClass("rui-messenger-item")) {
            ...
            if ((n.addClass("open show"), i.addClass("open show"), r.length)) {
              ...
              r.scrollTop(l),
                s.css("border-right") &&
                  r.find(".os-content").css("border-right", "");
            } else {
              var u = o.add("> div").innerHeight() - o.innerHeight();
              o.scrollTop(u);
            }
          }
          e.hasClass("rui-messenger-back") &&
            (n.removeClass("open"),
            i.removeClass("open"),
            setTimeout(function () {
    ...
    function E() {
      s.on(
        "click",
        ".rui-mailbox-item, .rui-mailbox-content-back",
        function (t) {
          t.preventDefault();
          var e = a(this),
            n = e.closest(".rui-mailbox"),
            i = n.find(".rui-mailbox-content");
          e.hasClass("rui-mailbox-item") &&
            (n.addClass("open show"), i.addClass("open show")),
            e.hasClass("rui-mailbox-content-back") &&
              (n.removeClass("open"),
              i.removeClass("open"),
              setTimeout(function () {
                n.removeClass("show"), i.removeClass("show");
    ...
    function U() {
      function t(t, e) {
        t.css({
          ...
          transform: "translate("
            .concat(e.position().left, "px, ")
            .concat(e.position().top, "px)"),
        });
      }
      function e() {
      ...
      e(),
        r.on("rui-ajax-loaded", e),
        s.on("click", ".rui-tabs-link", function (e) {
          e.preventDefault();
          var n = a(this),
    ...
    function O() {
      function t() {
        a("input.rui-spotlightmode-toggle").prop(
          "checked",
          l.hasClass("rui-spotlightmode")
        );
      }
      t(),
    ...
    function W() {
      function t() {
        a("input.rui-sectionLines-toggle").prop(
          "checked",
          l.hasClass("rui-section-lines")
        );
      }
      t(),
        s.on("change", "input.rui-sectionLines-toggle", function () {
    ...
    function Y() {
      if (void 0 !== window.YAYBAR) {
        ...
        t.each(function () {
          ...
          c.data("yaybar", s),
            s.setOptions(H),
            s.init(c),
            d.hasClass("dropdown-triangle") &&
              d.append('<span class="dropdown-menu-triangle"></span>'),
            l.hasClass("yay-hide") && o(),
            l.hasClass("rui-spotlightmode") && o(),
            c.on("show.yaybar hide.yaybar", function (t) {
              c.hasClass(i)
                ? ("show" === t.type && T(1), "hide" === t.type && T(0))
                : T(0);
            });
          var h = "",
            p = !1;
          function f() {
            !p && u < H.resizeSmallWnd
              ? (c.removeClass("yay-hide-to-small"),
                (p = !0),
                setTimeout(v, 100))
              : p &&
                u >= H.resizeSmallWnd &&
                (c.addClass("yay-hide-to-small"), (p = !1), setTimeout(v, 100)),
              u < H.resizeWnd
                ? h ||
                  ((h = t.hasClass(e)
                    ? e
                    ...
                    ? n
                    : !t.hasClass(i) || i),
                  c.removeClass("".concat(e, " ").concat(n)).addClass(i),
                  o())
                : h &&
                  (h !== i &&
                    (c
                      .removeClass("".concat(e, " ").concat(n, " ").concat(i))
                      .addClass(h),
                    t.data("yaybar").showYay()),
                  (h = ""));
          }
          u < H.resizeWnd && f(),
            r.on("ready load resize orientationchange", f),
          ...
          c(),
          s.on("change", "input.rui-staticSidebar-toggle", function () {
      ...
      function c() {
        a("input.rui-staticSidebar-toggle").prop(
          "checked",
          t.hasClass("yay-static")
        );
      }
    }
    function N() {
      void 0 !== a.fn.overlayScrollbars &&
        a(".rui-scrollbar:not(.rui-scrollbar-ready)")
          .addClass("rui-scrollbar-ready")
          .overlayScrollbars({ scrollbars: { clickScrolling: !0 } });
    }
    function B() {
          ...
          if ((e.preventDefault(), "" !== a(this).attr("href"))) {
            ...
            t.length
              ? n.animate(
                  {
                    scrollTop:
                      a(a.attr(this, "href")).offset().top - t.innerHeight(),
                  },
                  500
                )
              : n.animate(
    ...
    function L() {
      void 0 !== a.fn.ionRangeSlider &&
        a(".rui-irs:not(.rui-irs-ready)")
          ...
          .each(function () {
            ...
            function d() {
              n.length &&
                ...
                void 0 !== e.data("to") &&
                n.text(
                  "".concat(e.data("from")).concat(u).concat(e.data("to"))
                ),
                n.length && void 0 === e.data("to") && n.text(e.data("from"));
            }
            i && (c.min = i),
              o && (c.max = o),
              r && (c.step = r),
              s && ((c.type = "single"), (c.from = s)),
              l && ((c.type = "double"), (c.to = l)),
              u && (c.values_separator = u),
              (c.grid = !1),
              (c.drag_interval = !1),
              (c.onStart = function () {
                d();
    ...
    function Q() {
      void 0 !== a.fn.TouchSpin &&
        a(".rui-touchspin:not(.rui-touchspin-ready)")
          ...
          .each(function () {
            ...
            "true" === r && (s.verticalbuttons = r),
              n && (s.min = n),
              i && (s.max = i),
              o && (s.step = o),
              e
                ? ((s.buttondown_class = "btn ".concat(e, " btn-uniform")),
                  (s.buttonup_class = "btn ".concat(e, " btn-uniform")))
                : ((s.buttondown_class = "btn btn-grey-2 btn-uniform"),
                  (s.buttonup_class = "btn btn-grey-2 btn-uniform")),
              t.TouchSpin(s);
          });
    }
    function K() {
            ...
            e.daterangepicker({
              ...
              e.on("apply.daterangepicker", function (t, i) {
                n
                  ? e.val(
                      ""
                        .concat(i.startDate.format(n), " - ")
                        .concat(i.endDate.format(n))
                    )
                  : e.val(
                      ""
                        .concat(i.startDate.format("MM/DD/YYYY"), " - ")
              ...
              e.on("showCalendar.daterangepicker", function () {
                ...
                ).appendTo(a(".daterangepicker").find(".prev, .next")),
                  t.initPluginFeather();
              });
          });
      }
      ...
      if (void 0 !== a.fn.datetimepicker) {
        ...
        a(".rui-datetimepicker:not(.rui-datetimepicker-ready)")
          ...
          .each(function () {
            ...
            function s(t) {
              u < 576 &&
                !t.parent(".rui-datetimepicker-wrap").length &&
                t.wrap('<div class="rui-datetimepicker-wrap"></div>'),
                u > 576 &&
                  t.parent(".rui-datetimepicker-wrap").length &&
                  t.unwrap();
            }
            n && (r.format = n),
              "false" === i && (r.datepicker = !1),
              "false" === o && (r.timepicker = !1),
              (r.onGenerate = function () {
                var e = a(".xdsoft_datetimepicker");
                e.hasClass("feather-complete") ||
                  (a(
                    '<span stroke-width="1.5" data-feather="chevron-left" class="rui-icon"></span>'
                  ).appendTo(e.find(".xdsoft_prev, .xdsoft_next")),
                  a(
                    '<span stroke-width="1.5" data-feather="home" class="rui-icon"></span>'
                  ).appendTo(e.find(".xdsoft_today_button")),
                  t.initPluginFeather(),
                  e.addClass("feather-complete")),
                  s(e),
                  v(function () {
                    s(e);
                  });
    ...
    function J() {
      void 0 !== a.fn.dataTable &&
        a(".rui-datatable:not(.rui-datatable-ready)")
          ...
          .each(function () {
            ...
            if (e) {
              ...
              s &&
                ...
                s &&
                  !l &&
                  (r.order = [parseInt(s.split(":")[0], 10), s.split(":")[1]]);
            }
            "false" === n && (r.searching = !1),
              "false" === i && (r.paging = !1),
              "false" === o && (r.info = !1),
              t.dataTable(r);
          });
      ...
      if (void 0 !== a.fn.jstree) {
        ...
        a(".rui-jstree:not(.rui-jstree-ready)")
          ...
          .each(function () {
            var e = a(this);
            e.jstree(),
              e.on("open_node.jstree", function () {
                t.initPluginFeather();
              });
          });
      }
    ...
    function X() {
      "undefined" != typeof Pickr &&
        (a(".rui-colorpicker:not(.rui-colorpicker-ready)")
          ...
          .each(function () {
            var t = a(this),
              ...
              r = {};
            n.length ||
              (a('<div class="rui-colorpicker-addon"></div>').appendTo(t),
              t.addClass("rui-colorpicker-presence-addon")),
              e.length ? (r.default = String(e.val())) : (r.default = n.text()),
              (r.defaultRepresentation = o || "HEX"),
              (r.el = t[0].querySelector(".rui-colorpicker-addon")),
              (r.position = "bottom-end"),
              (r.components = {
                preview: !0,
                opacity: !0,
                hue: !0,
            ...
            function l(t) {
              ...
              u < 576 &&
                !e.length &&
                t.wrap('<div class="rui-colorpicker-wrap"></div>'),
                u > 576 && e.length && t.unwrap();
            }
            (e.length || i.length) &&
              (s.on("save", function () {
                e.val(
                  s.getColor()["to".concat(s._representation)]().toString()
                ),
                  i.text(
                    s.getColor()["to".concat(s._representation)]().toString()
                  );
            ...
            s.on("init", function (t) {
              ...
              l(e),
                ...
                void 0 === c ||
                  e.parents(".rui-colorpicker-wrap") ||
                  e.css({
        ...
        s.on("click", ".rui-colorpicker-input", function () {
          ...
          t.hasClass("rui-colorpicker-presence-addon") &&
            t.find(".pcr-button").click();
        }));
    }
    function Z() {
    ...
    function $() {
      void 0 !== window.hljs &&
        a("pre:not(.hljs) code").each(function () {
    ...
    function tt() {
      if (void 0 !== a.fn.emojioneArea) {
        var t = this;
        a(".rui-messenger:not(.rui-messenger-emojione-ready)")
          ...
          .each(function () {
            var e = a(this)
              ...
              .emojioneArea({
                tones: !1,
                autocomplete: !0,
                textcomplete: { maxCount: 5, placement: "top" },
                search: !1,
                inline: !0,
                hidePickerOnBlur: !0,
                shortnames: !0,
                ...
                events: {
                  ready: function () {
                    a(".emojionearea-button-open").html(
                      '<span stroke-width="1.5" data-feather="smile" class="rui-icon"></span>'
                    ),
                      a(".emojionearea-button-close").html(
                        '<span stroke-width="1.5" data-feather="x" class="rui-icon"></span>'
                      ),
                      t.initPluginFeather();
                  },
                },
            ...
            e.on("picker.show", function () {
              var t = e.picker;
              t.hasClass("rui-messenger-picker-complete") ||
                (t.append(
                  '<span class="rui-messenger-picker-triangle"></span>'
                ),
                t
                  .find(".rui-messenger-picker-triangle")
                  .offset({
    ...
    function et() {
      "undefined" != typeof Sortable &&
        a(".rui-sortable:not(.rui-sortable-ready)")
    ...
    function nt() {
      "undefined" != typeof EasyMDE &&
        a(".rui-markdown:not(.rui-markdown-ready)")
          .addClass("rui-markdown-ready")
          .each(function () {
            new window.EasyMDE({ element: this }).codemirror.on(
              "optionChange",
              function (t) {
                t.options.fullScreen
                  ? l.addClass("rui-markdown-fullscreen")
                  : l.removeClass("rui-markdown-fullscreen");
              }
            );
          });
    }
    ...
    function at() {
      "undefined" != typeof Swiper &&
        a(".rui-swiper:not(.rui-swiper-ready")
          ...
          .each(function () {
            ...
            if (
              (n.length &&
                i.length &&
                (v.navigation = { nextEl: i[0], prevEl: n[0] }),
              o && (v.initialSlide = parseInt(o, 10) || 0),
              r && (v.loop = !0),
              s && (v.grabCursor = !0),
              l && (v.centeredSlides = !0),
              c && (v.autoHeight = !0),
              h && (v.autoplay = { delay: h }),
              p && (v.speed = p),
              (v.slidesPerView = "auto" === f ? f : parseInt(f, 10)),
              g && (v.spaceBetween = g),
              d)
            ) {
              for (
            ...
            k.on("showed.yaybar hidden.yaybar", function () {
              ...
              u < C &&
                k.one("showed.yaybar hidden.yaybar", function () {
                  b.update();
                });
          });
    }
    function ot() {
      void 0 !== a.fn.inputmask &&
        a(".rui-inputmask:not(.rui-inputmask-ready)")
        ...
        a(".rui-selectize:not(.rui-selectize-ready)")
          ...
          .each(function () {
            var e = a(this),
              ...
              o = {};
            n.hasClass("rui-selectize-input") &&
              ((o.delimiter = ","),
              (o.persist = !1),
              (o.create = function (t) {
              ...
              (o.onInitialize = function () {
                if (n.hasClass("rui-selectize-select")) {
                  ...
                  1 !== i.length ||
                    a.find(".rui-selectize-select-icon").length ||
                    i.appendTo(a.addClass("rui-selectize-select-icon"));
                }
                n.hasClass("rui-selectize-icon") && t.initPluginFeather();
              }),
              (o.onChange = o.onInitialize),
              n.hasClass("rui-selectize-icon") &&
                ((o.render = {
                  option: function (t) {
                    return t.selectize
                      ? '<div class="option">'
                          .concat(t.selectize, " ")
                          .concat(t.text, "</div>")
                      : '<div class="option">'.concat(t.text, "</div>");
                  },
                }),
                (o.render.item = o.render.option),
                (o.onDropdownOpen = function () {
                  t.initPluginFeather();
                })),
              n.hasClass("rui-selectize-github") &&
                ((o.valueField = "url"),
                (o.labelField = "name"),
                (o.searchField = "name"),
                (o.option = []),
                ...
                (o.load = function (t, e) {
                  t.length
                    ? a.ajax({
                        url: "https://api.github.com/legacy/repos/search/".concat(
    ...
    function st() {
      "undefined" != typeof Quill &&
        a(".rui-quill:not(.rui-quill-ready)")
